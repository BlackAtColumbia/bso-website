...
const InstagramFeed = () => {
    ...
    return (
        <div className="instagram-feed-container" style={{ display: 'flex', justifyContent: 'center', margin: '2rem 0' }}>
            <blockquote
                className="instagram-media"
                data-instgrm-permalink="https://www.instagram.com/columbiabso/?utm_source=ig_embed&amp;utm_campaign=loading"
                ...
                style={{
                    ...
                    margin: '1px',
                    maxWidth: '800px', /* Widened from 540px */
                    minWidth: '326px',
                    padding: 0,
                    width: 'calc(100% - 2px)'
                }}
            >
                <div style={{ padding: '16px' }}>
                    <a
                        href="https://www.instagram.com/columbiabso/?utm_source=ig_embed&amp;utm_campaign=loading"
                        style={{
                            background: '#FFFFFF',
                            lineHeight: 0,
                            padding: '0 0',
                    ...
                    <p style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', lineHeight: '17px', marginBottom: 0, marginTop: '8px', overflow: 'hidden', padding: '8px 0 7px', textAlign: 'center', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                        <a href="https://www.instagram.com/columbiabso/?utm_source=ig_embed&amp;utm_campaign=loading" style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', fontStyle: 'normal', fontWeight: 'normal', lineHeight: '17px' }} target="_blank" rel="noreferrer">Black@CU</a> (@<a href="https://www.instagram.com/columbiabso/?utm_source=ig_embed&amp;utm_campaign=loading" style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', fontStyle: 'normal', fontWeight: 'normal', lineHeight: '17px' }} target="_blank" rel="noreferrer">columbiabso</a>) • Instagram photos and videos
                    </p>
                </div>
            </blockquote>
        </div>
